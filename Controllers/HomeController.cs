...
public class HomeController : Controller
{
    ...
    /* Nesse trecho do código foram criadas as instâncias de clientes e fornecedores, 
    respeitando os parâmetros solicitados no construtor que está no model Cliente e Fornecedor. */
    public IActionResult Index()
    {
        Cliente cliente1 = new Cliente(01, "Arthur A. Ferreira", "857.032.950-41", "arthur.antunes@sp.senai.br", "Madruga");
        Cliente cliente2 = new Cliente(02, "William Henry Gates III", "039.618.250-09", "bill@microsot.com", "Bug");
